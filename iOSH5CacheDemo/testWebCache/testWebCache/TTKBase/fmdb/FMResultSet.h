...
@class TTKFMDatabase;
@class TTKFMStatement;

/** Represents the results of executing a query on an `<TTKFMDatabase>`.
...
@interface TTKFMResultSet : NSObject {
    TTKFMDatabase          *_parentDB;
    TTKFMStatement         *_statement;
...
/** `TTKFMStatement` used by result set. */

@property (atomic, retain) TTKFMStatement *statement;

///------------------------------------
/// @name Creating and closing database
///------------------------------------

/** Create result set from `<TTKFMStatement>`
 
 @param statement A `<TTKFMStatement>` to be performed
 
 @param aDB A `<TTKFMDatabase>` to be used
 
 @return A `TTKFMResultSet` on success; `nil` on failure
 */

+ (instancetype)resultSetWithStatement:(TTKFMStatement *)statement usingParentDatabase:(TTKFMDatabase*)aDB;

/** Close result set */

- (void)close;

- (void)setParentDB:(TTKFMDatabase *)newDb;
