...
/** Category of additions for `<TTKFMDatabase>` class.
...
@interface TTKFMDatabase (FMDatabaseAdditions)
...
/** The schema of the database.
 ...
 @return `TTKFMResultSet` of schema; `nil` on error.
 
 @see [SQLite File Format](http://www.sqlite.org/fileformat.html)
 */

- (TTKFMResultSet*)getSchema;
...
- (TTKFMResultSet*)getTableSchema:(NSString*)tableName;
