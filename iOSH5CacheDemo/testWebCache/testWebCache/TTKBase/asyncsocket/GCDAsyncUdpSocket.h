...
@interface TTKGCDAsyncUdpSocket : NSObject

/**
 * TTKGCDAsyncUdpSocket uses the standard delegate paradigm,
 ...
 * If you pass NULL, TTKGCDAsyncSocket will automatically create its own socket queue.
 ...
 * 
 * This means TTKGCDAsyncUdpSocket automatically supports both protocols,
 * and can send to IPv4 or IPv6 addresses,
 * as well as receive over IPv4 and IPv6.
 * 
 * For operations that require DNS resolution, TTKGCDAsyncUdpSocket supports both IPv4 and IPv6.
 * If a DNS lookup returns only IPv4 results, TTKGCDAsyncUdpSocket will automatically use IPv4.
 * If a DNS lookup returns only IPv6 results, TTKGCDAsyncUdpSocket will automatically use IPv6.
 ...
 * This is due to the fact that TTKGCDAsyncUdpSocket does NOT copy the data.
 ...
 * 
 * Important Note:
 * TTKGCDAsyncUdpSocket may be running in parallel with your code.
 * That is, your delegate is likely running on a separate thread/dispatch_queue.
 * When you invoke this method, TTKGCDAsyncUdpSocket may have already dispatched delegate methods to be invoked.
 ...
 * 
 * The TTKGCDAsyncUdpSocket instance may optionally be used again.
 ...
 * 
 * Generally TTKGCDAsyncUdpSocket doesn't use CFStream. (It uses the faster GCD API's.)
...
@protocol TTKGCDAsyncUdpSocketDelegate
@optional
...
**/
- (void)udpSocket:(TTKGCDAsyncUdpSocket *)sock didConnectToAddress:(NSData *)address;
...
**/
- (void)udpSocket:(TTKGCDAsyncUdpSocket *)sock didNotConnect:(NSError *)error;

/**
 * Called when the datagram with the given tag has been sent.
**/
- (void)udpSocket:(TTKGCDAsyncUdpSocket *)sock didSendDataWithTag:(long)tag;

/**
 * Called if an error occurs while trying to send a datagram.
 * This could be due to a timeout, or something more serious such as the data being too large to fit in a sigle packet.
**/
- (void)udpSocket:(TTKGCDAsyncUdpSocket *)sock didNotSendDataWithTag:(long)tag dueToError:(NSError *)error;

/**
 * Called when the socket has received the requested datagram.
**/
- (void)udpSocket:(TTKGCDAsyncUdpSocket *)sock didReceiveData:(NSData *)data
...
**/
- (void)udpSocketDidClose:(TTKGCDAsyncUdpSocket *)sock withError:(NSError *)error;
