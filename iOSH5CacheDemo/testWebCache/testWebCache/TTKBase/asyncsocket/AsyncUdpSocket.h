...
@class TTKAsyncSendPacket;
@class TTKAsyncReceivePacket;
...
@interface TTKAsyncUdpSocket : NSObject
{
	...
	TTKAsyncSendPacket *theCurrentSend;
	NSTimer *theSendTimer;
	
	NSMutableArray *theReceiveQueue;
	TTKAsyncReceivePacket *theCurrentReceive;
...
/**
 * Creates new instances of TTKAsyncUdpSocket.
**/
- (id)init;
...
/**
 * Creates new instances of TTKAsyncUdpSocket that support only IPv4 or IPv6.
...
/**
 * When you create an TTKAsyncUdpSocket, it is added to the runloop of the current thread.
...
@protocol TTKAsyncUdpSocketDelegate
@optional

/**
 * Called when the datagram with the given tag has been sent.
**/
- (void)onUdpSocket:(TTKAsyncUdpSocket *)sock didSendDataWithTag:(long)tag;

/**
 * Called if an error occurs while trying to send a datagram.
 * This could be due to a timeout, or something more serious such as the data being too large to fit in a sigle packet.
**/
- (void)onUdpSocket:(TTKAsyncUdpSocket *)sock didNotSendDataWithTag:(long)tag dueToError:(NSError *)error;
 ...
 * and TTKAsyncUdpSocket will continue as if the packet never arrived.
...
**/
- (BOOL)onUdpSocket:(TTKAsyncUdpSocket *)sock
...
**/
- (void)onUdpSocket:(TTKAsyncUdpSocket *)sock didNotReceiveDataWithTag:(long)tag dueToError:(NSError *)error;

/**
 * Called when the socket is closed.
 * A socket is only closed if you explicitly call one of the close methods.
**/
- (void)onUdpSocketDidClose:(TTKAsyncUdpSocket *)sock;
