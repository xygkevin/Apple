...
#import "MTAValueTransformers.h"
#pragma mark-- PassThrough

@implementation MTAPassThroughValueTransformer
...
@implementation MTABOOLToNSNumberValueTransformer
...
@implementation MTACATransform3DToNSDictionaryValueTransformer
...
@implementation MTACGAffineTransformToNSDictionaryValueTransformer
...
@implementation MTACGColorRefToNSStringValueTransformer
...
@implementation MTACGPointToNSDictionaryValueTransformer
...
@implementation MTACGRectToNSDictionaryValueTransformer
...
@implementation MTACGSizeToNSDictionaryValueTransformer
...
#pragma mark-- NMTAttributedString To NSDictionary

@implementation MTANMTAttributedStringToNSDictionaryValueTransformer
...
//				[MTABaseFunction logDebug:@"Failed to convert HTML to NMTAttributed string: %@", error];
			}
...
@implementation MTANSNumberToCGFloatValueTransformer
